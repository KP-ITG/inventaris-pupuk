                    ...
                    <div class="px-6 py-4 border-b border-gray-200">
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex space-x-2">
                                <a :href="route('admin.kategori.export-excel')" target="_blank"
                                ...
                                <a :href="route('admin.kategori.export-pdf')" target="_blank"
                                ...
                                <button @click="openModal()" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md text-sm font-medium inline-flex items-center">
